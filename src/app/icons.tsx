...
export function Free() {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g id="giao h&#195;&#160;ng" clipPath="url(#clip0_1627_3909)">
        <g id="cube">
...
export function ArrowTopRightActive() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="13"
...
export function ArrowSlideLeft() {
  return (
    <svg
      width=""
      height=""
...
export function ArrowSlideRight() {
  return (
    <svg
      width=""
      height=""
      ...
      <div className="left flex items-center">
        ...
        <div className="">
          ...
          <ul className="list-color flex mt-[0.75rem]">
            <li className="color-detail color-detail-product-1 border-[100%] mr-[0.5rem]">
              <svg
            ...
            <li className="color-detail color-detail-product-2  border-[100%] mr-[0.5rem] active">
              <svg
                className="w-[1.25rem] h-[1.25rem]"
                xmlns="http://www.w3.org/2000/svg"
                width=""
            ...
            <li className="color-detail color-detail-product-3 border-[100%] mr-[0.5rem] ">
              <svg
                className="w-[1.25rem] h-[1.25rem]"
                xmlns="http://www.w3.org/2000/svg"
                width=""

      ...
      {isShowArrow && (
        <>
          <div
            ...
            } ${keySlide === "flash-sale" ? "max-md:hidden" : ""} max-lg:z-[2] top-[36%] absolute z-20 w-[4.5rem] h-[4.5rem] cursor-pointer max-md:opacity-90 max-md:h-[8rem] max-md:w-[8rem] max-md:left-[-4.5rem]`}
          >
            <ArrowSlideLeft />
          </div>
          <div
            ...
            } ${keySlide === "flash-sale" ? "max-md:hidden" : ""} max-lg:z-[2]  top-[36%] absolute z-20 w-[4.5rem] h-[4.5rem] cursor-pointer max-md:opacity-90 max-md:h-[8rem] max-md:w-[8rem] max-md:right-[-4.5rem]`}
          >
            <ArrowSlideRight />
          </div>
        </>

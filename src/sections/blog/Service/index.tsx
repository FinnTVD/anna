...
const ServiceBlog = () => {
  return (
    <div className="py-[6.25rem] px-[5rem] md:px-[10rem] pb-8 md:pb-0">
      <h4 className="text-black text-[9rem] md:text-[2.25rem] font-semibold">GÓC TƯ VẤN CHỌN KÍNH ĐẸP</h4>
      <div className="py-0 md:py-[2.5rem] flex flex-wrap">
        ...
        <div className="flex items-center w-full md:w-2/5 bg-stone-300 ">
          <div className="px-[6rem] md:px-[2rem] py-[5rem] md:py-[2rem]">
            ...
            <h5 className="text-[5rem] md:text-[1.75rem] font-semibold pt-10 md:pt-0">Trải nghiệm những chiếc kính kết hợp và trọng lượng nhẹ từ bộ sưu tập mới</h5>

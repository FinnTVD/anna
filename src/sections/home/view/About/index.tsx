...
function AboutHome({ dataAbout }: IpropAbout) {
  const phrase =
    "Được thành lập từ năm 2015, trải qua hơn 8 năm phát triển kính mắt Anna đã, đang và sẽ chiếm vị trí không thể thiếu đối với các bạn trẻ. Với quy mô trên toàn quốc, Anna sẽ tiếp tục mở rộng thêm chi nhánh để mang những sản phẩm chất lượng đến tay người dùng";
  const refs = useRef([]);
  ...
  return (
    <div className="about p-12 sm:p-24 flex justify-between flex-wrap">
      <div className="w-full md:w-1/2 px-4 pt-10">
        <h4 className="text-white text-[64px] font-black uppercase">
          {dataAbout?.title}
        </h4>

...
function ActionHome({ dataTrip }: IPropsAction) {
  return (
    <div
      className="p-[6.67rem] sm-px-0 sm:py-24 bg-cover"
    ...
    >
      <div className="container">
        <div className="flex justify-between items-end">
          ...
          />
          <div className="h-[50px] pl-5 pr-1 py-2 bg-zinc-800 bg-opacity-30 rounded-[100px] border border-white backdrop-blur-[5px] justify-between items-center gap-3 inline-flex">

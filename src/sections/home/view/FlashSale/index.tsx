...
const dataSlide: any = [
  {
    ...
    item_product:
    {
      ...
      price: 120000,
      sale_price: 150000,
      featuredImage: "https://woo-api.okhub.tech/wp-content/uploads/2023/12/20231117_xa44VCCaw2.jpeg",
      ratings: "3",
      shortDescription: "",
      description: "asdasd",
      categories: [
    ...
    <div>
      <div className="mx-[6.25rem] mb-[5rem] max-lg:mx-[3.25rem] mt-[3.75rem] relative max-sm:mx-0 max-sm:mb-[3.5rem]">
        <div className="flex mb-[2.62rem] items-center max-sm:mb-[1rem] max-sm:px-[0.75rem]">
          ...
          <ICLine />
          <h4 className="text-[32px] uppercase leading-[56px] pl-[1.688rem]">bán chạy nhất</h4>
        </div>
        <div>

  ...
  return (
    <div className="px-4 md:px-0 border-t border-b border-teal-300 max-md:mt-[5.6rem] max-md:py-[4.27rem] max-md:bg-[#EEFBFB] flex justify-center">
      <div className="container mx-auto max-lg:mx-[0.75rem] grid gap-4 grid-cols-2 md:grid-cols-4 max-md:flex-wrap text-[#454545] max-md:bg-[#EEFBFB] py-[1.875rem] max-md:py-[0rem]">
        <div className="flex  justify-center max-lg:mr-[0.9rem]  max-lg:p-[0.5rem] items-center p-[1.25rem] rounded-[3.125rem] border-[1px] border-[#CAF2F1] max-md:mb-[4.26667rem] max-md:mr-[0.5rem] max-md:rounded-none max-sm:border-none max-sm:justify-start">
        ...
        <div className="flex justify-center max-lg:mr-[0.9rem]  max-lg:p-[0.5rem] items-center p-[1.25rem] rounded-[3.125rem] border-[1px] border-[#CAF2F1] max-md:mb-[4.26667rem] max-sm:ml-[0.5rem] max-sm:rounded-none max-sm:border-none  max-sm:justify-start max-sm:mr-0">
          <div className="max-md:hidden">
        ...
        <div className="flex justify-center max-lg:mr-[0.9rem]  max-lg:p-[0.5rem] items-center p-[1.25rem] rounded-[3.125rem] border-[1px] border-[#CAF2F1]  max-sm:mb-[1rem] max-sm:mr-[0.5rem] max-sm:rounded-none max-sm:border-none  max-sm:justify-start">
          <div className="max-md:hidden">

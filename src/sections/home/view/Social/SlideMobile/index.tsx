...
export default function SlideMobileSocial() {
  ...
  return (
    <div className="w-full h-[157rem] relative md:hidden">
      ...
      <div className="absolute z-10 w-full top-[3.73rem] px-[3.2rem]">
        <div className="flex items-center ">
          ...
          <div className="w-full ml-[2.13rem]">
            <h2 className="text-white text-[4.26667rem] md:text-[2.26667rem] font-extrabold leading-normal">
              Social of Anna
            </h2>
            <span className="block text-[3.2rem] font-normal leading-[1.3] text-white">
      ...
      <span className="absolute block bottom-[22.4rem] left-1/2 -translate-x-1/2 z-20 text-white text-[3.7333rem] font-bold leading-normal">
        @annaeyeglasses
      </span>

...
export default function Action() {
  ...
  return (
    <div className="md:w-[87.5rem] mx-auto md:mt-[6.25rem] md:h-[58.4375rem] rounded-[1.25rem] bg-[#6fb6b3] pt-[4.31rem] pb-[4.94rem] px-[3.965rem]">
      <div className="flex justify-between items-center flex-wrap">
        <div className="md:w-[40rem] max-sm:mt-[24.27rem]">
          <h2 className="text-[7.46667rem] md:text-[3.5rem] text-white font-bold leading-[1.3] tracking-[-0.175rem]">
            Các Hoạt Động Chính
          </h2>
          <h3 className="text-white font-medium leading-[1.3] tracking-[-0.0625rem] mt-[0.75rem] text-[3.73333rem] md:text-[1rem]">
            ”Hành Trình Tử Tế” được khởi hành với 3 nhóm hoạt động chính
          </h3>
        </div>
        <button className="rounded-[6.5rem] border border-solid border-white px-[2rem] py-[0.75rem] hidden md:flex items-center h-fit">
      ...
      <div className="grid grid-cols-2 gap-x-[2rem] h-[35.875rem]">
        <div className="bg-white rounded-[1rem] h-full px-[2rem] pb-[2rem] pt-[3rem]">
          <h2
            className="font-bold text-[4.26667rem] md:text-[2rem] text-[#414141] hover:text-[#7BD7D6] cursor-pointer"
            onClick={handleOpen}
          >
            Đôi Mắt Mặt Trời
          </h2>
        ...
        <div className="bg-white rounded-[1rem] h-full px-[2rem] pb-[2rem] pt-[3rem]">
          <h2 className="font-bold text-[4.26667rem ] md:text-[2rem] text-[#414141]">
            Túi Tử Tế
          </h2>
          <div className="border-t border-solid border-[#414141]/60 my-[1.12rem]"></div>
          <p className="text-[1.25rem] text-[#414141]/70 font-medium leading-[1.4] tracking-[-0.0375rem] w-[26.3125rem] mb-[2.31rem]">
      ...
      <button className="rounded-[6.5rem] border border-solid border-white px-[2rem] py-[0.75rem] flex md:hidden items-center h-fit">
          <span className="block mr-[1.5rem] text-white font-medium leading-[1.57] tracking-[-0.03rem]">
            Cộng đồng sống tử tế
          </span>
          <svg

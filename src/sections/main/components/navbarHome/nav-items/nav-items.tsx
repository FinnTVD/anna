      ...
      >
        ...
        <ul className="h-full grow flex justify-between primary-nav md:flex text-[11px] font-bold items-center ml-[2.12rem]">
          ...
          >
            ...
            >
              <HoverCardTrigger asChild>
                ...
                >
                  <span
                    className={`mr-[0.38rem] not-italic font-bold text-[#454545] text-[1.125rem] leading-[1.575rem] ${styleNavbar ? 'text-[#454545]' : 'text-[#fff]'
                      }`}
                  >
                    Sản phẩm
                  </span>
          ...
          <li className="has-child">
            <Link href='/system-store' className="tab-menu flex items-center ml-[1.75rem]">
              <span
